...
This project aims to create an interactive digital map where users can:
- Select a day on the timeline (February–March 1917)
- See events that occurred on the selected day displayed on the map
- View routes of revolutionary detachments, troops, and demonstrators
...
We welcome contributions from historians, developers, and anyone interested. For collaboration, please open an Issue.
